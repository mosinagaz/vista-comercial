                                            ...
                                            @foreach($usuarios as $usuario)
                                                @php
                                                    ...
                                                    if ($hour >= 12) {
                                                        ...
                                                        $link="https://api.whatsapp.com/send?phone=591".$usuario->celular." &text=".$greeting.", le comparto el link del reporte backorder semana 3 de Agosto.%0Ahttps://devpromedical.online/informacion/gestor/".$usuario->gestor;
                                                @endphp
                                                <tr>
                                                    <th scope="row"><a href="#"
